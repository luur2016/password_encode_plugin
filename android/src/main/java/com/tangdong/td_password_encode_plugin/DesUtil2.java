 ...
 * <pre>
 * DES鍔犲瘑瑙ｅ瘑宸ュ叿
 * 鍔犲瘑锛欴esUtils.encode("admin","1,2,3");
 * 瑙ｅ瘑锛欴esUtils.decode("012C2C9BA925FAF8045B2FD9B02A2664","1,2,3");
 * </pre>
 *
 * @author amos
 * @version $Id: DesUtil.java, v 0.1 2018骞�10鏈�13鏃� 涓嬪崍3:56:27 amos Exp $
 */
public class DesUtil2 {
	...
	/**
	 * DES鍔犲瘑锛坰ecretKey浠ｈ〃3涓猭ey锛岀敤閫楀彿鍒嗛殧锛�
	 */
...
//		String[] ks = StringUtils.split(secretKey, ",");
	...
	/**
	 * DES瑙ｅ瘑锛坰ecretKey浠ｈ〃3涓猭ey锛岀敤閫楀彿鍒嗛殧锛�
	 */
...
//		String[] ks = StringUtils.split(secretKey, ",");
	 ...
	 *
	 * @author amos
	 * @version $Id: DesUtil.java, v 0.1 2018骞�10鏈�13鏃� 涓嬪崍3:56:59 amos Exp $
	 */
